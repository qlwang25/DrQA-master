...
data_dir = os.path.join(abs_path, 'data/datasets/sourcedata')
out_dir = os.path.join(abs_path, 'data/datasets')

parser = argparse.ArgumentParser()
parser.add_argument('-data_dir', type=str, default=data_dir, help='Path to SQuAD data directory')
parser.add_argument('-out_dir', type=str, default=out_dir, help='Path to output file dir')
