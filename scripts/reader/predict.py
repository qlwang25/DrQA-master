...
"""A script to make and wikipedia model predictions on an input dataset."""
...
# Defaults
DATA_DIR = os.path.join(DRQA_DATA, 'datasets/sourcedata', 'train-v1.1.json')
# MODEL_DIR = '/tmp/drqa-models/'
MODEL_DIR = os.path.join(DRQA_DATA, 'reader/single.mdl')
EMBED_DIR = os.path.join(DRQA_DATA, 'embedding')
OUT_DIR = os.path.join(DRQA_DATA, 'out')
...
parser.add_argument('--embedding-file', type=str, default=EMBED_DIR,
